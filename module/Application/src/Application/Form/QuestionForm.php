...
class QuestionForm extends Form
{
    public function __construct()
    {
        ...
        $this->add(array('name' => 'question_title', 'type' => 'textarea', 'options' => array('label' => 'Digite sua pergunta'), 'attributes' => array('required' => true, 'style' => 'min-height: 200px; max-height: 500px; min-width: 500px; max-width: 1000px', 'class' => 'form-control')));
